...
public class ExceptionController implements Controller{
    ...
    private ExceptionHandler clientNotFound = (e, ctx)-> {
        logger.warn("User attempted to retrieve information that was not found. Exception message is " + e.getMessage());
        ctx.status(404);
    ...
    public void mapEndpoints(Javalin app) {
        app.exception(ExpectedExceptions.class, clientNotFound);
